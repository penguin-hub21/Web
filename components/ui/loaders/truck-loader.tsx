  ...
  return (
      <div className={styles.loader}>
        <div className={styles.truckWrapper}>
          ...
          <svg xmlSpace="preserve" viewBox="0 0 453.459 453.459" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1" fill="#000000" className={styles.lampPost}>
